...
/** Utility functions used by the ZioCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ZIO addresses in monospace font
...
// Parse "ziocoin:" URI into recipient object, return true on successful parsing
