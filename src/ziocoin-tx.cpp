...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Zio Coin Core ziocoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ziocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zio coin transaction") + "\n" +
                               "  ziocoin-tx [options] -create [commands]   " + _("Create hex-encoded zio coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zio coin transaction
