...
// Copyright (c) 2017 The Zio Coin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000a0d785b96bdcc1319471bcbe96cc6125b15b62a2e8ba9798e1cbfdf01d3"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1531985875, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
         ...
         */
        const char* pszTimestamp = "19. 07. 2018 ziocoin launch prepare";
        ...
        assert(hashGenesisBlock == uint256("0x00000a0d785b96bdcc1319471bcbe96cc6125b15b62a2e8ba9798e1cbfdf01d3"));
        assert(genesis.hashMerkleRoot == uint256("0xc3eb9c172628c7e85fae50225cef9d972a4019b07b5d6867056e71b8f76fc9f8"));

        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("seed1", "202.182.125.0"));
        //vSeeds.push_back(CDNSSeedData("seed2", "45.76.208.174"));
        vSeeds.push_back(CDNSSeedData("seed3", "45.32.39.236"));

        vSeeds.push_back(CDNSSeedData("seed4", "198.13.44.149"));
        //vSeeds.push_back(CDNSSeedData("seed5", "202.182.103.143"));
        vSeeds.push_back(CDNSSeedData("seed6", "209.97.160.175"));

        // Zio Coin addresses start with 'G'
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 29835;
        assert(hashGenesisBlock == uint256("0x377ff2c169adfeab64b9aa766e3b862622197d8e10c70a0f6eb4c05f729777f4"));
